...
```powershell
python laser_scanner.py   --video C:\path\to\cup1.mp4   --intrinsics C:\path\to\K.txt   --distortion C:\path\to\dist.txt   --marker-width 0.210 --marker-height 0.297   --output output\cup1.ply   --debug-video output\cup1_debug.mp4
```
